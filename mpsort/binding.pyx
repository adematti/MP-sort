...
cdef extern from "mp-mpiu.h":
    ctypedef void * (*mpiu_malloc_func)(const char * name, size_t size, const char * file, const int line, void * userdata) except *
...
cdef void * pymalloc(const char * name, size_t size, const char * file, const int line, void * userdata):
